...
const Nav = () => {
	...
	console.log('user in fo in nav',userInfo,isLoggedIn);
					...
					!isLoggedIn ?
						<>
							<li className={`mega-menu`}>
								<Link href={`/login`} className={`active`}><a>Login</a></Link>
							</li>
							<li className={`mega-menu`}>
								<Link href={`/signup`} className={`active`}><a>Signup</a></Link>
							</li>
						</>
						:
						<>
							<li className={`mega-menu`}>
								<Link href={`/`} className={`active`}><a onClick={(e) => logout(e)}>Logout</a></Link>
							</li>
							<li className={`mega-menu`}>
								<Link href={`/user/profile`} className={`active`}><a>{userInfo?.name || userInfo?.email || userInfo?.phone || 'My Profile'}</a></Link>
							</li>
						</>
				}
